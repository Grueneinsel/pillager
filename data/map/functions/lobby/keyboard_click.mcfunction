...
scoreboard players operation @e[type=area_effect_cloud,tag=directional_vector] z /= 1000 int
scoreboard players operation @s x += @e[type=area_effect_cloud,tag=directional_vector] z
tellraw @a [{"text":"z= "},{"score":{"name":"@s","objective":"z"}},{"text":"   n= "},{"score":{"name":"@s","objective":"x"}}]

...
scoreboard players remove @e[type=!armor_stand,tag=keyboard_pos] y 5375
...
execute store result entity @e[tag=keyboard_v,limit=1] Pos[2] double 0 run scoreboard players get @s x

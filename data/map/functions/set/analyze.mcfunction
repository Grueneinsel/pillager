...
execute as @e[type=minecraft:area_effect_cloud,tag=test_room,tag=scan_path] run if score @s connection matches 2 run function map:set/2con
execute as @e[type=minecraft:area_effect_cloud,tag=test_room,tag=scan_path] run if score @s connection matches 3 run function map:set/3con
execute as @e[type=minecraft:area_effect_cloud,tag=test_room,tag=scan_path] run if score @s connection matches 4 run function map:set/4con

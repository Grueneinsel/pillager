...
execute as @e[type=area_effect_cloud,tag=stair_entrance,tag=door,scores={y=14}] at @s rotated as @s positioned ^ ^-9 ^6 run scoreboard players set @e[type=area_effect_cloud,tag=stair_entrance,distance=..8] turn 5
...
execute as @e[type=area_effect_cloud,tag=stair_entrance,tag=door,scores={y=5}] at @s rotated as @s positioned ^ ^9 ^6 run scoreboard players set @e[type=area_effect_cloud,tag=stair_entrance,distance=..8] turn 5

...
execute as @e[type=area_effect_cloud,tag=connection,scores={path=2},distance=..7] rotated as @s at @s positioned ^ ^ ^-6 run tag @e[type=area_effect_cloud,tag=door,tag=path_found] add connected_to_current_room

...
scoreboard players operation @e[type=area_effect_cloud,tag=tp_me,limit=1] x = x count
scoreboard players operation @e[type=area_effect_cloud,tag=tp_me,limit=1] z = z count

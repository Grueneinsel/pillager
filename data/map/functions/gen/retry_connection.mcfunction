...
execute  run say RETRY

execute if entity @p[tag=debugmsg] if score retry count matches 1 run say Retry 1
...
execute if entity @p[tag=debugmsg] if score retry count matches 2 run say Retry 2
...
execute if entity @p[tag=debugmsg] if score retry count matches 2 run say Retry 3

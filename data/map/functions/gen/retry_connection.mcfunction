...
execute if score retry count matches 2 unless score reset count matches 3 run function map:gen/remove_path
...
execute if score reset count matches 3 if entity @s[tag=2x2] run function map:gen/

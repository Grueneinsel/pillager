...
execute at @e[type=area_effect_cloud,tag=reconnect_me] as @e[type=area_effect_cloud,tag=reconnect_me] rotated as @s at @s positioned ^ ^ ^-6 run function map:gen/connect_back

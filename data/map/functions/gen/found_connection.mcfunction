...
execute at @e[type=area_effect_cloud,tag=reconnect_me] run tag @e[type=area_effect_cloud,tag=entrance,distance=..1] add path_found
execute at @e[type=area_effect_cloud,tag=reconnect_me] at @e[type=area_effect_cloud,tag=entrance,distance=..1] run setblock ~ ~1 ~ stone
...
execute as @e[type=area_effect_cloud,tag=blue_block] at @s if entity @e[type=area_effect_cloud,tag=!blue_block,distance=..1] run kill @s

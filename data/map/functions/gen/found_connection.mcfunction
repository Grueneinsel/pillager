...
execute as @e[type=area_effect_cloud,tag=pot_connection] at @s rotated as @s positioned ^ ^ ^6 as @e[type=area_effect_cloud,tag=connection,distance=..7,scores={path=2}] at @s rotated as @s run function map:gen/connect_merge

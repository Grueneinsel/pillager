...
execute at @e[type=area_effect_cloud,tag=reconnect_me] run scoreboard players set @e[type=area_effect_cloud,tag=connection,distance=..1,scores={path=3..4}] path 1
execute at @e[type=area_effect_cloud,tag=reconnect_me] run say @e[type=area_effect_cloud,tag=connection,distance=..1,scores={path=3..4}]

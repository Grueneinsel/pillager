...
execute at @e[type=area_effect_cloud,tag=reconnect_me] run scoreboard players set @e[type=area_effect_cloud,tag=connection,tag=!reconnect_me,distance=..1,scores={path=4}] path 1

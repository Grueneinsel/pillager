...
execute if entity @s[scores={count=5..,type=0}] run scoreboard players set @s count 0
execute if entity @s[scores={count=3..,type=1}] run scoreboard players set @s count 0
execute if entity @s[scores={count=2..,type=2}] run scoreboard players set @s count 0
execute if entity @s[scores={count=5..,type=3}] run scoreboard players set @s count 0
execute if entity @s[scores={count=3..,type=4}] run scoreboard players set @s count 0

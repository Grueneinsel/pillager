...
execute if entity @s[scores={count=5..,type=0..1}] run function map:gen/get_type
execute if entity @s[scores={count=2..,type=2..3}] run function map:gen/get_type
execute if entity @s[scores={count=3..,type=4}] run function map:gen/get_type
...
execute if score @s type matches 3 run setblock ~ ~ ~ structure_block{mode:"LOAD",name:"2tiles_1_doors"}
...
execute if entity @s[tag=skip] unless score @s types matches 0 run function map:gen/rotate_2tiles

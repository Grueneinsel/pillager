...
execute if entity @s[tag=path_found] run say yes nice
execute if entity @s unless entity @s[tag=path_found] unless entity @e[tag=connect_me] run say oh no
...
#execute if entity @s unless entity @s[tag=path_found] unless entity @e[tag=connect_me] run function map:gen/retry_connection

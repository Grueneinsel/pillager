...
execute if entity @s unless entity @s[tag=path_found] if entity @e[type=area_effect_cloud,tag=connect_me] run say AAAAAAHHHHHHHH2
execute if entity @s unless entity @s[tag=path_found] if entity @e[type=area_effect_cloud,tag=connect_me] run function map:gen/search_connection
execute unless entity @s[tag=path_found] unless entity @e[type=area_effect_cloud,tag=connect_me] run say oh no
execute unless entity @s[tag=path_found] unless entity @e[type=area_effect_cloud,tag=connect_me] run function map:gen/retry_connection

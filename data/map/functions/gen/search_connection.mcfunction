...
##Rotate latest AECs
execute at @e[type=area_effect_cloud,tag=latest_connection] if block ~ ~ ~ blue_concrete run tag @s add blue_block
...
execute if entity @s[tag=blue_block] run function map:gen/found_connection

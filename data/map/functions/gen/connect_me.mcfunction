...
execute rotated as @s positioned ^ ^ ^12 if block ~ 4 ~ red_concrete unless block ~ ~ ~ birch_planks run summon area_effect_cloud ~ ~ ~ {Tags:["pot_connection","latest_connection","connection","gen","connect_me","new_connection","straight"],Duration:1000000}
execute rotated as @s positioned ^6 ^ ^6 if block ~ 4 ~ red_concrete unless block ~ ~ ~ birch_planks run summon area_effect_cloud ~ ~ ~ {Tags:["pot_connection","latest_connection","connection","gen","connect_me","new_connection","turn_left","turn_me"],Duration:1000000}

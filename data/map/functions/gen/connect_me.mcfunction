...
execute rotated as @s positioned ^ ^ ^12 if block ~ 4 ~ red_concrete unless block ~ ~ ~ birch_planks run summon area_effect_cloud ~ ~ ~ {Tags:["pot_connection","connection","gen","connect_me","new_connection"],Duration:1000000}
